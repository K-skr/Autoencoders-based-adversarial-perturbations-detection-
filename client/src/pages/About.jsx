  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen">
      <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a href="https://flowbite.com/" className="flex items-center space-x-3 rtl:space-x-reverse">
            ...
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-gray-900 dark:text-white">PDS</span>
          </a>
      ...
      <img 
        ...
        className='ml-32 size-7/12 pl-96 pt-24'
      />
      <div>
        <p className="pt-8 p-28 text-base leading-relaxed text-gray-800 dark:text-gray-300">
          Adversarial Perturbations pose a major threat for machine learning systems, majorly affecting their reliability especially in critical applications
          like healthcare, autonomous driving, finance, etc. This project proposes
          a novel approach for adversarial perturbation detection uses autoencoders'
          ...
          the systems can effectively adversarial attacks in real time. The use of
