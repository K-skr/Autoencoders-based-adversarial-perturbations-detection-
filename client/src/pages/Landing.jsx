        ...
        <div className="h-screen pb-14 bg-right bg-cover" style={{"backgroundImage":"url('bg.svg')"}}>
          ...
          <div className="container pt-24 md:pt-48 px-6 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
              <h1 className="my-4 text-3xl md:text-5xl text-purple-800 font-bold leading-tight text-center md:text-left slide-in-bottom-h1">ADVERSARIAL PERTURBATION DETECTION</h1>
              <p className="leading-normal text-base md:text-2xl mb-8 text-center md:text-left slide-in-bottom-subtitle">Detect perturbation in your data. Make it just right!</p>
            ...
            <div className="w-full xl:w-3/5 py-6 overflow-y-hidden">
              ...
              <p className="p-4 font-light dark:text-gray-400">
                                <i>Sign in to start using</i> <a href="signin" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Login here</a>
                            </p>
            </div>
